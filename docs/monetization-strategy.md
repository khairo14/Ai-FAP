...
- Annual discount: Encourages commitment and improves LTV
- Family plan: Better value per user, attracts larger market segment
...
1. **Receipt Limit Hit:**
   - "You've used 10/10 free scans this month. Upgrade for unlimited!"
   
2. **Valuable Insight Generated:**
   - "Premium users get 5x more insights like this. Unlock now!"
   
3. **Goal Creation:**
   - "Premium users reach their goals 40% faster with AI planning."
...
**Year 1 Net:** -$165,000 (acceptable for growth stage)
